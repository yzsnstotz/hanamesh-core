...
function HanaMeshSection(): ReactNode {
  ...
  return createElement('section', {className: 'hm-core-section', 'data-hanamesh-core': 'ready'},
    ...
    createElement(Row, {label: '账号'}, createElement('div', {className: 'hm-core-actions'}, createElement('span', null, '绑定状态：绑定后在网站查看（Stage 1 无设备可读端点）'), createElement('button', {type: 'button', onClick: () => visit('/me/bind')}, '去网站绑定'))),
    ...
    createElement(Row, {label: '关于'}, createElement('div', {className: 'hm-core-actions'}, createElement('span', null, 'hanamesh-core 0.2.0-rc.8 · DSH 0.1.5-alpha.1'), createElement('button', {type: 'button', onClick: () => visit('/')}, '去网站'))),
  );
}
