...
publish_if_missing hanamesh-usage 0.2.0-rc.7 ./vendor/siblings/hanamesh-usage-0.2.0-rc.7.tgz
publish_if_missing @hanamesh/dsh-app-host 0.1.0-rc.31 ./vendor/siblings/hanamesh-dsh-app-host-0.1.0-rc.31.tgz
publish_if_missing hanamesh-core 0.2.0-rc.30 ./artifacts/hanamesh-core-0.2.0-rc.30.tgz
